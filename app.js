...
function handleMenuAction(action){
  ...
  if(action === 'explore'){
    ...
    trending.forEach(t=>{
      ...
      el.innerHTML = `<div class="meta"><div class="avatar"><img src="logo.svg" style="width:100%;height:100%;object-fit:cover;border-radius:10px"></div><div class="author"><strong><span class="display-name">OMGSocial</span>${renderBadges({admin:true,verified:false})}</strong><div class="handle">@omgsocial</div></div></div><div class="content">${escapeHtml(t)}</div>`;
